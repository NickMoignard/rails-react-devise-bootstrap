...
import { FormCsrfInput } from '../../../components/FormCsrfInput'
...
class DevisePasswordsEdit extends React.Component {
  ...
  handleSubmit(event) {
    ...
    if (user.password && user.passwordConfirmation) {
      this.props.dispatch(userActions.changePassword(user))
    }
  }

  render() {
    const { resetingPassword, errors } = this.props
...
function mapStateToProps(state) {
  const { resetingPassword, errors } = state.users
